...
@Slf4j
public class CustomeCodeGrantAuthenticationProvider implements AuthenticationProvider {
    ...
    public CustomeCodeGrantAuthenticationProvider(OAuth2AuthorizationService authorizationService, OAuth2TokenGenerator<? extends OAuth2Token> tokenGenerator, AuthUserService userDetailsService, PasswordEncoder passwordEncoder) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        User user;
        AuthUser exisitingAuthUser;
        try {
            // fetch user from database
            // then pass the email address as username
            exisitingAuthUser = userDetailsService.findByEmail(username);
            user = (User) userDetailsService.loadUserByUsername(exisitingAuthUser.getEmailAddress());
        } catch (UsernameNotFoundException | AuthServerException e) {
