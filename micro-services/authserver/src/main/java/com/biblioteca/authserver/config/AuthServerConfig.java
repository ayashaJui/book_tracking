...
import com.biblioteca.authserver.providers.custompasswordgrant.CustomCodeGrantAuthenticationConverter;
import com.biblioteca.authserver.providers.custompasswordgrant.CustomeCodeGrantAuthenticationProvider;
...
public class AuthServerConfig {
    ...
    public SecurityFilterChain authServerSecurityFilterChain(HttpSecurity http, DataSource dataSource, RegisteredClientRepository clientRepository) throws Exception {
                                ...
                                .tokenEndpoint(tokenEndpoint -> {
                                    try {
                                        tokenEndpoint
                                                ...
                                                .authenticationProvider(new CustomeCodeGrantAuthenticationProvider(
                                                        authorizationService(dataSource, clientRepository),
                                                        tokenGenerator(),
                                                        authUserService,
                                                        passwordEncoder()));
    ...
    @Bean
    OAuth2TokenGenerator<? extends OAuth2Token> tokenGenerator() throws NoSuchAlgorithmException {
